...
public class Controller {
    ...
    public ResponseEntity<MessageResponse<String>> status() {
    	return ResponseEntity.ok(new MessageResponse<>("SOS Service Operational!"));
    }

    @PostMapping()
    public ResponseEntity<MessageResponse<String>> save(@RequestPart("file") MultipartFile file) throws IOException {
